...
;
    ...
    det_filename_ask_str    db "please enter matrix filename: ", 0
    ...
    ask_det                 db "do you want to calculate a determinant (y - as yes, any other key - no): ",0
    ask_op                  db "please enter operation(+,-,*):"
...
_select_op_minus:
    mov word ptr [mat_ob], _mat_diff
    jmp _select_op_done


_select_op_plus:
    mov word ptr [mat_ob], _mat_sum
    jmp _select_op_done

_select_op_mul:
    mov word ptr [mat_ob], _mat_mul
    jmp _select_op_done
...
_det_calc proc near
    ...
    push offset det_filename_ask_str
    call _putstr
    add sp, 2
